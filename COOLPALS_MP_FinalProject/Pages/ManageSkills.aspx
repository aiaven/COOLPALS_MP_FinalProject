...
<head runat="server">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-header p { font-size: 0.95rem; color: #8A8A8A; line-height: 1.65; }
        ...
        .btn-primary { background: #CC0000; box-shadow: 0 4px 18px rgba(204,0,0,0.22); }
        .btn-primary:hover { background: #A80000; }
        .btn-secondary { background: #0D1B3E; }
...
<form id="form1" runat="server">
    ...
    <div class="page-body">
            ...
            <div class="form-card">
                ...
                <div class="form-grid">
                    <div class="form-field">
                        ...
                        <asp:TextBox ID="txtSkillName" runat="server" CssClass="form-input" placeholder="e.g. Mathematics" />
                    </div>
                    <div class="form-field">
                    ...
                    <div class="form-field full-width">
                        ...
                        <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" CssClass="form-textarea" placeholder="Brief description of the skill..." />
                    </div>
                </div>
                <div class="nav-buttons">
                    <asp:Button ID="btnSaveSkill" runat="server" Text="Save Skill"
                        CssClass="btn-action btn-save" OnClick="btnSaveSkill_Click" />
                    <asp:Button ID="btnCancelEdit" runat="server" Text="Cancel"
                        CssClass="btn-action btn-cancel" OnClick="btnCancelEdit_Click" CausesValidation="false" />
                </div>
            </div>
        </asp:Panel>
        ...
        <div class="search-bar">
            ...
            <asp:Button ID="btnShowAddNew" runat="server" Text="+ Add New Skill"
                CssClass="btn-action btn-save" OnClick="btnShowAddNew_Click" Visible="false" />
        </div>
